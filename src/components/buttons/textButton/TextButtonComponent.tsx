    ...
    return [
      {
        ...
        backgroundColor: props.disabled
          ? props.colorDisable ?? Colors.COLOR_GREY_FEEBLE
  ...
  if (props.isTextFixed) {
    return (
      <TouchableOpacity
        ...
        {(Boolean(props.iconOrImageAffix) || props.isLoading) && (
          <View style={{}}>
            {props.iconOrImageAffix}
            {props.isLoading && (
              <ActivityIndicator
                size={props.ActivityIndicatorSize ?? 25}
        ...
        {Boolean(props.iconOrImageSuffix) && (
          <View style={{}}>{props.iconOrImageSuffix}</View>
        )}
      </TouchableOpacity>
    );
  } else {
    return (
      <TouchableOpacity
        ...
        onPress={props.onPress}>
        {(Boolean(props.iconOrImageAffix) || props.isLoading) && (
          <View style={styles['container__icon--left']}>
            {props.iconOrImageAffix}
            {props.isLoading && (
              <ActivityIndicator
                size={props.ActivityIndicatorSize ?? 25}
        ...
        {props.title}
        {Boolean(props.iconOrImageSuffix) && (
          <View style={styles['container__icon--right']}>
