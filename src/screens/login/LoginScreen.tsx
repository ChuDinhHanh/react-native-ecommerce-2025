...
const LoginScreen = () => {
  ...
  const [
    login,
    {
      data: dataLoginNormal,
      isLoading: isLoadingLoginNormal,
      isError: isErrorLoginNormal,
      error: errorLoginNormal,
      isFetching: isFetchingLoginNormal,
    },
  ] = useLazyLoginQuery();
  ...
  const [
    loginByGoogle,
    {
      ...
      isFetching: isFetchingLoginGoogle,
    },
  ] = useLazyLoginByGoogleQuery();
  ...
  useEffect(() => {
    ...
    if (isErrorLoginGoogle) {
      ...
      Alert.alert(
        t('Alert.warning'),
        `${textError?.data?.message}` || t('Alert.loginFail'),
      );
    }
  ...
  return (
    <ContainerComponent isFull isScrollEnable>
      {/* wrapper*/}
      <View style={styles.container}>
        {/* Top */}
        <View style={[styles.container__top, globalStyles.center]}>
          <FastImage
            style={styles['container__top--image']}
          ...
          <SessionComponent>
            ...
            <Formik
              ...
              {({
                ...
                <View>
                  <CustomTextInput
                    suffix={<SimpleLineIcons name="user" size={scale(21)} />}
                    placeholder={t(
                  ...
                  <TextButtonComponent
                    ...
                    title={
                      <TextComponent
                        ...
                        text={t('LoginScreen.textForgotPassword')}
                      />
                    }
                  />
        ...
        <View style={[styles.container__bottom, globalStyles.center]}>
          <LoginTextQuestionComponent isLogin={true} navigation={navigation} />
