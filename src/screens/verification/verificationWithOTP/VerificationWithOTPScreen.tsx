...
const VerificationWithOTPScreen = () => {
  ...
  const [
    checkCodeResetEmail,
    {
      isError: isErrorCodeReset,
      isFetching: isFetchingCodeReset,
      isLoading: isLoadingResetCode,
      data: dataCodeReset,
      error: errorCheckCodeReset,
    },
  ] = useLazyCheckCodeResetEmailQuery();
  const [
    forgotPassword,
  ...
  return (
    <ContainerComponent
      ...
      <SessionComponent padding={scale(29)}>
        ...
        <TextComponent
          text={`${t(
            'VerificationWithOTPScreen.textSendVerificationFor',
          )} ${email}.`}
          fontSize={15}
          color={Colors.BLACK}
        />
