    ...
    return (
        <View style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    <View
                        style={{
                            ...
                            flex: 1, backgroundColor: Colors.WHITE, borderWidth: .5, borderColor: "#ccc", borderRadius: 999
                        }}
                    >
                        <TextInput
                            placeholder="Search"
                        ...
                        />
                        {
                            query && <IconButton containerColor={Colors.WHITE} onPress={() => setQuery('')} icon={'close'} />
                        }
                    </View>
                    <IconButton style={{ alignSelf: 'flex-end' }} containerColor={Colors.WHITE} onPress={searchPlaces} icon={'magnify'} />
                </View>
            ...
            <View style={{
                ...
                <IconButton style={{ alignSelf: 'flex-end', borderWidth: 1, position: 'absolute', right: moderateScale(10), bottom: 100 }} containerColor={Colors.WHITE} onPress={getCurrentLocation} icon={'crosshairs-gps'} />
                <TextButtonComponent
