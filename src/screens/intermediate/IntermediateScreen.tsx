...
const IntermediationScreen = () => {
  ...
  const data = [
    {
      name: t('ImmediateScreen.textTitleDropDownSelectRegisterWithFacebook'),
      value: '1',
    },
    {
      name: t('ImmediateScreen.textTitleDropDownSelectRegisterWithGoogle'),
      value: '2',
    },
  ];
            ...
            <TextButtonComponent
              ...
              title={
                <TextComponent
                  fontWeight="bold"
                  color={Colors.WHITE}
                  text={t('ImmediateScreen.textButtonLeft')}
                />
              }
            ...
            <TextButtonComponent
              ...
              title={
                <TextComponent
                  fontWeight="bold"
                  color={Colors.WHITE}
                  text={t('ImmediateScreen.textButtonRight')}
                />
              }
