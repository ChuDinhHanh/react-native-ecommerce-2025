          ...
          <View style={styles['container__wrapper--inside']}>
            ...
            <View>
              ...
              <View style={styles['wrapper__inside--right']}>
                <FastImage
                  style={styles['inside__right--image']}
                  source={require('../../../../assets/images/data/product/truckShip.png')}
                />
            ...
            {/* Divider */}
            <View style={styles['wrapper__inside--divider']} />
            {/* Node */}
            <View>
              ...
              <View style={styles['bottom__node--right']}>
                <FastImage
                  style={styles['node__right--image']}
